...
Names = {
    ...
    ["perk_stainless_armour"]               = {"Stainless Armour", "Stainless Armor"},
    ...
    ["perk_angry_ghost"]                    = {"Angry Ghost", ">:(", "Unhappy Ghost", "Angy Ghost", "Angy Gost", "Angry Gost", "Unhappy Gost"},
    ["perk_hungry_ghost"]                   = {"Hungry Ghost", ":)", "Happy Ghost", "Gappy Gost", "Happy Gost", "Hungry Gost"},
    ["perk_death_ghost"]                    = {"Mournful Spirit", "Death Ghost", ":|", "Mournful Gost", "Mournful Ghost", "Death Spirit"},
